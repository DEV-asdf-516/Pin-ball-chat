...
def set_conversation_user_profile(conn: sqlite3.Connection, conversation_id: str, user_profile_id: str) -> dict:
...
def set_conversation_title(conn: sqlite3.Connection, conversation_id: str, title: str | None) -> dict:
    conversation_found: bool = exists(conn, ReadQuery.by_id(CONVERSATIONS, conversation_id))
    ensure(conversation_found, "conversation not found")

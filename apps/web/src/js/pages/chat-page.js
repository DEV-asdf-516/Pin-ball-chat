  ...
  return el("section", { id: "chatScreen", className: "screen" }, [
    ...
    el("form", { id: "composer", className: "composer" }, [
      ...
      el("div", { className: "composer-input-wrap" }, [
        ...
        }, [el("span", { className: "composer-symbol-glyph", text: "@" })]),
        el("button", {
      ...
      el("button", {
        id: "cancelComposerEditBtn",
        className: "composer-symbol composer-cancel",
        type: "button",
        attrs: { hidden: "", title: "편집 취소", "aria-label": "편집 취소" },
      }, [el("span", { className: "composer-symbol-glyph", text: "×" })]),
      el("button", {
        id: "sendBtn",
